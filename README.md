...
While the Stata scripts use .dta data and the R scripts use .rds, both datasets are derived from the same raw source files provided in the [data](https://github.com/atyho/AI-Replication-Games/tree/main/data) folder.
